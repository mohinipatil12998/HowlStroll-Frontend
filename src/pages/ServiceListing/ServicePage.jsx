...
const mockDogWalkers = [
  {
    ...
    description:
      "Experienced and reliable dog walker with 5+ years of experience. Specializes in long walks and playful fetch sessions.",
  ...
  },
  {
    ...
    description:
      "Certified pet sitter and walker who loves all breeds. Offers custom walking routes and basic training reinforcement.",
    serviceType: "Dog Walker",
  },
  {
    id: 3,
    ...
    description:
      "Passionate dog lover available for daily walks and weekend adventures. Your dog's safety and happiness are my top priority!",
    serviceType: "Dog Walker",
  },
];
...
const mockVets = [
  {
    ...
    description:
      "Experienced and compassionate veterinarian specializing in preventative care and advanced surgical procedures for all pets.",
  ...
  },
  {
    ...
    description:
      "A friendly vet who provides expert care in a calm and comforting environment. Focuses on holistic wellness and urgent care needs.",
    serviceType: "Veterinarian",
  },
];
...
export const ServicePage = () => {
  ...
  switch (serviceType) {
    case "dog-walkers":
      ...
      pageSubtitle =
        "Browse a selection of verified and highly-rated pet sitters and walkers.";
      break;
    case "vets":
      providersData = mockVets;
      pageTitle = "Find a Veterinarian";
      pageSubtitle =
        "Connect with top-rated vets for all your pet's health needs.";
      break;
    case "pet-sitters":
      providersData = mockDogWalkers;
  ...
  return (
    <>
      ...
      <Modal
        ...
        title={
          <h1 className="text-3xl font-extrabold text-center text-[#4a2f1b] mb-2">
            Book a Service
          </h1>
        }
        submitText={"Book the Appointment"}
      >
        <BookService />
      </Modal>
    </>
